...
- Do not add your IDE's project files to project's `gitignore` - add them to your local `.gitignore` instead. See [this section](https://github.com/rezwits/meccg/wiki/Getting-Started-with-Development#gitignore) for more info.
...
- If you are just starting out, check out our [development guide](https://github.com/rezwits/meccg/wiki/Getting-Started-with-Development) - you may find a few things that are useful there.
