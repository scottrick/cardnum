...
(defn add-faces [card-text]
  (-> (if (nil? card-text) "" card-text)
      ...
      (create-face "rune-p-18-1+18mm" "img/dice/rune-p-18-1@2x.png")
      (create-face "rune-p-18-2+18mm" "img/dice/rune-p-18-2@2x.png")
      (create-face "rune-p-18-3+18mm" "img/dice/rune-p-18-3@2x.png")
      (create-face "rune-p-18-4+18mm" "img/dice/rune-p-18-4@2x.png")
      (create-face "rune-p-18-5+18mm" "img/dice/rune-p-18-5@2x.png")
      (create-face "rune-p-18-6+18mm" "img/dice/rune-p-18-6@2x.png")
      ...
      (create-face "rune-w-18-1+18mm" "img/dice/rune-w-18-1@2x.png")
      (create-face "rune-w-18-2+18mm" "img/dice/rune-w-18-2@2x.png")
      (create-face "rune-w-18-3+18mm" "img/dice/rune-w-18-3@2x.png")
      (create-face "rune-w-18-4+18mm" "img/dice/rune-w-18-4@2x.png")
      (create-face "rune-w-18-5+18mm" "img/dice/rune-w-18-5@2x.png")
      (create-face "rune-w-18-6+18mm" "img/dice/rune-w-18-6@2x.png")
      ))