...
(defn add-faces [card-text]
  (-> (if (nil? card-text) "" card-text)
      ...
      (create-face "rune-s-18-1+18mm" "img/dice/rune-s-18-1@2x.png")
      (create-face "rune-s-18-2+18mm" "img/dice/rune-s-18-2@2x.png")
      (create-face "rune-s-18-3+18mm" "img/dice/rune-s-18-3@2x.png")
      (create-face "rune-s-18-4+18mm" "img/dice/rune-s-18-4@2x.png")
      (create-face "rune-s-18-5+18mm" "img/dice/rune-s-18-5@2x.png")
      (create-face "rune-s-18-6+18mm" "img/dice/rune-s-18-6@2x.png")
      ...
      (create-face "rune-g-18-1+18mm" "img/dice/rune-g-18-1@2x.png")
      (create-face "rune-g-18-2+18mm" "img/dice/rune-g-18-2@2x.png")
      (create-face "rune-g-18-3+18mm" "img/dice/rune-g-18-3@2x.png")
      (create-face "rune-g-18-4+18mm" "img/dice/rune-g-18-4@2x.png")
      (create-face "rune-g-18-5+18mm" "img/dice/rune-g-18-5@2x.png")
      (create-face "rune-g-18-6+18mm" "img/dice/rune-g-18-6@2x.png")
      ...
      (create-face "rune-r-18-1+18mm" "img/dice/rune-r-18-1@2x.png")
      (create-face "rune-r-18-2+18mm" "img/dice/rune-r-18-2@2x.png")
      (create-face "rune-r-18-3+18mm" "img/dice/rune-r-18-3@2x.png")
      (create-face "rune-r-18-4+18mm" "img/dice/rune-r-18-4@2x.png")
      (create-face "rune-r-18-5+18mm" "img/dice/rune-r-18-5@2x.png")
      (create-face "rune-r-18-6+18mm" "img/dice/rune-r-18-6@2x.png")
      ...
      (create-face "rune-a-18-1+18mm" "img/dice/rune-a-18-1@2x.png")
      (create-face "rune-a-18-2+18mm" "img/dice/rune-a-18-2@2x.png")
      (create-face "rune-a-18-3+18mm" "img/dice/rune-a-18-3@2x.png")
      (create-face "rune-a-18-4+18mm" "img/dice/rune-a-18-4@2x.png")
      (create-face "rune-a-18-5+18mm" "img/dice/rune-a-18-5@2x.png")
      (create-face "rune-a-18-6+18mm" "img/dice/rune-a-18-6@2x.png")
