(ns meccg.main
  (:require [goog.events :as events]
            ...
            [meccg.about :refer [about]]
            [meccg.auth :refer [auth-forms auth-menu]]
            [meccg.account :refer [account]]
            [meccg.cardbrowser :refer [card-browser]]
            [meccg.chat :refer [chat]]
            [meccg.deckbuilder :refer [deck-builder]]
            [meccg.gameboard :refer [concede gameboard game-state mute-spectators]]
            [meccg.gamelobby :refer [filter-blocked-games game-lobby leave-game player-view]]
            [meccg.help :refer [help]]
            [meccg.news :refer [news news-state]]
            [meccg.stats :refer [stats]]
            [reagent.core :as r])
