            ...
            {:id "commands"
             ...
             :content [:p "To use a command, type it in chatbox and press Enter. Some of the commands will bring up a prompt "
                       ...
                       [:ul
                        ...
                        [:li [:code "/counter color n"] " - set the specified counter type on a card to n (player's own cards only). Type must be " [:code "dark"] "/" [:code "light"] " blue, " [:code "black"] ", " [:code "purple"] ", or " [:code "red"] ". Can be abbreviated as " [:code "d"] ", "  [:code "l"] ", "  [:code "b"] ", "  [:code "p"] ", or " [:code "r"] " respectively."]
                        [:li [:code "/counters color n"] " - convenience plural form of /counter."]
                        [:li [:code "/counters n"] " - set counters on a card to n (player's own cards only). Attempts to infer the type of counter to place."]
                        ...
                        [:li [:code "/hide-temp-zone"] " - Moves all cards in your Temporary Zone to your Deciding"]
                        [:li [:code "/host"] " - Host a card on another card, using this will reveal all info in log"]
                        [:li [:code "/hh"] " - Shortcut to Host a card (Hidden) on another card, keeps info secret"]
                        [:li [:code "/hr"] " - Shortcut to Host a card (Revealed) on another card, keeps info secret"]
                        ...
                        [:li [:code "/move-fw-sb"] " - Pick a card from your play-area to put into your fw-dc-sb"]
                        ...
                        [:li [:code "/re-order n"] " - Put the order you want your hand to be in with n like 21436587"]
                        ...
                        [:li [:code "/reveal-hand-step"] " - Reveals cards from your hand one at a time"]
                        [:li [:code "/reveal-hand-random n"] " - Reveals a random n cards from your hand"]
                        [:li [:code "/reveal-deck-hidden n"] " - Reveals the top n cards from your deck to opponent, hidden from you"]
                        [:li [:code "/reveal-deck-show n"] " - Reveals the top n cards from your deck to your opponent"]
                        [:li [:code "/reveal-deck-self n"] " - Reveals the top n cards from your deck to just yourself"]
                        ...
                        [:li [:code "/show-deciding n"] " - Removes the Nth card from Deciding Box to All player Temporary Zone"]
                        [:li [:code "/score"] " - Use this to score a card"]
                        [:li [:code "/store"] " - Use this to store a card"]
                        [:li [:code "/swapc"] " - Use this to quickly swap characters"]
                        [:li [:code "/swaph"] " - Use this to quickly swap hazards"]
                        [:li [:code "/swapr"] " - Use this to quickly swap resources"]
                        [:li [:code "/swaps"] " - Use this to quickly swap sites and/or regions"]
