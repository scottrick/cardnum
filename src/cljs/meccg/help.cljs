    ...
    {:id "beginners"
     ...
     :sub (list
            {:id "learnrules"
             ...
             :content [:ul [:p "The first step is reading " [:a {:href "https://www.fantasyflightgames.com/ffg_content/android-meccg/support/android-meccg-core-rules.pdf" :target "_blank"} "the official rulebook"]
            ...
            {:id "finddecks"
             ...
             :content [:ul [:p [:a {:href "https://meccgdb.com/"} "MECCGDB"] " is a good radicle for finding decks of all kinds. "
            ...
            {:id "communities"
             ...
             :content [:ul
                        [:div "Apart from the chatrooms here on Cardnum.net, here are a few links to online MECCG communities:"
                         [:ul
    ...
    {:id "site"
     ...
     :sub (list
            ...
            {:id "fullscreen"
             ...
             :content [:ul
                        [:p "Add cardnum.net to your homescreen as described "
    ...
    {:id "cards"
     ...
     :sub (list
            {:id "shards"
             ...
             :content [:ul
                        [:p "At the last run step on the relevant locale, instead of pressing \"Successful Run\" button, "
            ...
            {:id "nasir"
             ...
             :content [:ul
                        [:p "Nasir's ability is currently triggered manually - when encountering a piece of Character, click Nasir's "
                       "identity card to trigger the ability."]]}
            {:id "adam"
             :title "How do I place Adam's directives?"
             :content [:ul
                        [:p "Adam's directives are placed automatically at the game start. The directives are pulled "
    ...
    {:id "troubleshooting"
     ...
     :sub (list
            ...
            {:id "touchproblems"
             ...
             :content [:ul
                        [:p "Touchscreen devcharacters are currently not supported. See answer to " [:a {:href "#bestbrowser"} "this question"]
            ...
            {:id "zerogames"
             ...
             :content [:ul
                        [:p "This is most likely a websocket issue. Check if your network filters let through traffic from ws.cardnum.net. "
            ...
            {:id "modded"
             ...
             :content [:ul
                        [:p "This is a format designed to make it easy for new players with a limited card pool. "
                         ...
                         "There is no use of the MWL/Most Wanted List. The name originated from Modern but sounds more MECCG. "
            ...
            {:id "onesies"
             ...
             :content [:ul
                        [:p "This is a community designed format designed to vary the card choice options. "
                         ...
                         "There is no use of the MWL/Most Wanted List. Refer to " [:a {:href "https://www.reddit.com/r/MECCG/comments/5238a4/1111_onesies/"} "Onesies"]]]}
            {:id "cache"
    ...
    {:id "getinvolved"
     ...
     :sub (list
            {:id "reportingbugs"
             ...
             :content [:ul
                        [:p "The best place to report bugs is the " [:a {:href "https://github.com/mtgred/meccg/issues" :target "_blank"} "GitHub issue tracker"]
            ...
            {:id "features"
             ...
             :content [:ul
                        [:p "Same as bugs - feature requests should go on the " [:a {:href "https://github.com/mtgred/meccg/issues" :target "_blank"} "GitHub issue tracker"]
            ...
            {:id "devs"
             ...
             :content [:ul [:p "Visit the project page on " [:a {:href "https://github.com/mtgred/meccg/" :target "_blank"} "GitHub"] " and fork "
