            ...
            {:id "commands"
             ...
             :content [:p "To use a command, type it in chatbox and press Enter. Some of the commands will bring up a prompt "
                       ...
                       [:ul
                        ...
                        [:li [:code "/host"] " - Host a card on another card"]
                        [:li [:code "/hh"] " - Shortcut to Host a card (Hidden) on another card"]
                        [:li [:code "/hr"] " - Shortcut to Host a card (Revealed) on another card"]
