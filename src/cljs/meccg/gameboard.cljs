...
(defn general-map [owner ref]
  [:svg {:style {:version "1.1"
   ...
   [:g {:id "regiones_x5F_vector_1_"}
    [:g {:id "Imlad_Morgul"}
     [:a {:id "Regiones_x2F_Imlad_x5F_Morgul.html"}
      [:g
       [:path {:className "st0" :d "M505.4,302.6c-0.2-0.4-0.8-0.5-1.2-0.7c-1-0.7-1.7-1.9-2.6-2.6c-0.5-0.4-1.3-0.4-1.7-0.8
					c-0.4-0.4-0.4-2-0.7-2.5c-0.5-0.8-2.2-0.9-2.8-1.6c-1.7,0-2.6,1.9-4.2,2.5h-0.7c-1,0.3-2.4,1-3.6,1.2c-0.6,0.1-1-0.6-1.8-0.4
					c-1,0.3-1.8,1.3-2.8,1.8c-0.5,0.2-1.3,0.1-1.6,0.2c-0.1,0.1-0.2,0.2-0.4,0.2v0.5c-0.7,0.1-0.7,0.3-1.2,0.6c0,0.6,0,2.2,0.2,2.6
					v0.2c0.5-0.1,0.4-0.2,1-0.2c0,0.6,0.4,1.1,0.6,1.6c2.8,0,7.1,0.3,8.4,1.3c0.3-0.1,0.5-0.3,0.7-0.5c0.1-0.3-0.1-0.6,0.1-1
					c0.1-0.4,0.4-0.6,0.8-0.7c0.1-0.1,2.9-0.5,3-0.5c0.7,0.2,1.2,0.7,1.7,1.1c0.4,0.3,1.7,0.5,2.2,0.6c1.6,0.4,5.5-0.6,6.1,0h0.2
					c0-0.4-0.1-1.1,0.1-1.3L505.4,302.6L505.4,302.6z"}]
       ]
      ]
     ]
    ...
    [:g {:id "Gorgoroth"}
     [:a {:id "Regiones_x2F_Gorgoroth.html"}
      [:g
       [:path {:className "st0" :d "M568.2,285.1c0-0.8-0.3-0.7-0.6-1.1c-1.5,0-1.8-0.2-2.8-0.5c-0.7-0.2-1.5,0.1-1.9,0.2
					c-0.7,0.2-1.7-0.1-2-0.2c-0.8-0.3-1.6,0.3-2.3-0.2c-0.9-0.1-1.1-0.9-1.1-1.9c0.6-0.6,0.9-1.3,1.7-1.8v-0.4
					c-0.8-0.1-2.4,0.4-3.4,0c-0.7-0.3-1-0.7-2-0.6c-0.2,0-0.5,0.4-0.7,0.5c-0.6,0.2-2.4,0.1-3.1-0.1c-0.5-0.1-0.9-0.7-1.3-0.8
					c-0.5-0.2-3.5-0.5-4.2-0.2c-0.5,0.2-1,0.8-1.6,1h-2.5c-0.8,0.2-1.6,0.6-2.4,0.8c-1.1,0.3-2-0.5-2.6-0.7c-0.9-0.4-2,0.3-2.5,0.5
					h-2.2c-0.1,0.1-0.2,0.4-0.4,0.5c-1.7,0.6-4.5-0.7-5.5-1c-1.5-0.4-3.3-0.3-4.7-0.6c-1.5-0.3-2.4,0.5-3.2,0.8h-1
					c-0.3,0.2-0.7,0.8-1.1,1c-1,0.4-2-0.3-3,0c-0.2,0.1-0.8,0.5-1.1,0.6c-1,0.4-2.2-0.2-3,0.2c-0.6,0.3-1.2,1.6-1.6,1.8
					c-0.6,0.4-1.9,0.1-2.4,0.5c-1.1,0.1-1.4-0.2-1.4-1.2c-0.4-0.2-0.6-0.2-0.7-0.6c-0.8,0.1-1.2,0.6-1.9,0.8
					c0.1,0.3,0.4,0.6,0.5,0.8c0.7,2.2-2.1,4-3,4.8c-0.1,0.1-0.2,2.2,0,2.8c0.1,0.4,3.3,3,3.7,3.1c0.2,1.2,0,1.3,0.6,2.4
					c0,0.3,0.1,0.6,0.1,0.8c0.2,0.5,1,0.5,1.3,0.8c0.3,0.4,0.4,0.8,0.8,1.1c0.5,0.3,1.4,0.2,1.9,0.6c0.3,0.2,0.3,0.6,0.6,0.8
					c0,0.4,0.1,0.4-0.2,0.6c0.2,0.6,0.8,0.7,1,1.2c0,1.1-0.1,2.2-0.1,3.2c0.1,0.2,0.2,1,0.4,1.2c0.2,0.3,0.6,0.4,0.7,0.7
					c0.1,0.3,0,0.6,0.1,0.8c0.3,0.5,1,0.8,1.4,0.8c0.2,0.4,0.9,1.6,0.7,1.8c-0.3,0.9-1.8,1.4-2.8,1.6c0.1,0.9,0.7,0.9,1.1,1.4
					c0.3,0.4,0.1,1.3,0.4,1.8c0.4,0.6,1.7,1.2,2.2,1.8c0.3,0.4,0.2,1.1,0.5,1.6c0.4,0.6,2.6,0.9,1.7,2.3c-0.5,1.3-3,1.4-4,2.3
					c-0.1,0.1,0.1,0.6,0.1,1.1c-0.4,0.3-0.5,0.6-0.8,1c-0.3,0.1-0.3-0.1-0.6,0c-0.4,0.2-1.5,1.4-1.9,1.7c-0.1,0.2,0,0.1-0.1,0.2v0.1
					c1.4,0.3,4.2-1,4.8-1.9c0.6-0.9,0.7-2.3,1.6-2.9c1-0.7,3-0.5,4.2-1.1c0.8-0.3,1.2-1.2,1.9-1.6c0.4-0.2,0.6,0,1.1-0.2
					c0.3-0.1,0.8-0.6,1.2-0.7c0.2,0,0.5-0.1,0.7-0.1c0.4-0.3,0.7-0.9,1.2-1.2c0.8-0.4,2-0.6,2.5-1.3c0.4-0.5,0.5-1.4,0.8-1.9
					c0.8-0.2,2-0.3,2.6,0.2c1.3,0,1.4,1.4,1.3,2.6c0.4,0.1,0.8,0.6,1.1,1c0.8-0.1,0.7-0.7,1.2-1.1c0.3-0.2,0.6-0.2,1-0.4
					c0-0.1,0.1-0.2,0.1-0.4h0.7c0.6-0.3,1.2-1.2,1.9-1.2c0-0.5,0.1-0.8-0.2-1c0.1-1.3,0.7-0.8,1.1-1.4c0-0.2,0.1-0.5,0.1-0.7
					c0.3-0.6,1.6-1.9,2.2-2.3c0.2-0.2,0.5,0,0.8-0.1c0.5-0.2,1.6-0.5,2.2-0.7h1.6c1.1-0.3,2.6-0.7,3.5-1.1c0.6-0.2,0.9,0,1.4-0.2
					c1.1-0.5,1.6-3.2,2.8-4.1c0.7-0.5,1.9-0.8,2.6-1.1h1c0.4-0.1,1.7-0.7,2-1c0.4-0.3,0.6-1,1-1.3c-0.4-0.4-4.2-2.1-4.9-1.7
					c-1.1,0-1.3-0.3-1.9-0.6c0-0.6-0.3-1.4,0-1.9c0.2-0.4,0.9-0.6,1.2-1c0.1-0.4,0.2-0.7,0.4-1.1c0.5-0.9,2.7-2.9,3.7-3.2h2.2
					c0-0.1,0.1-0.2,0.1-0.2h0.5v-0.2c0.5-0.3,1.1-0.2,1.6-0.5c0.5-0.3,0.7-1.2,1.6-1.6c0.3,0,0.6-0.1,1-0.1c0.3-0.1,0.8-0.6,1.1-0.7
					c0.6-0.3,1.2,0,1.9-0.2c0.7-0.3,1.6-0.7,2.3-1.1C568.5,286.1,568.5,285.5,568.2,285.1z"}]
       ]
      ]
     ]
    ]
